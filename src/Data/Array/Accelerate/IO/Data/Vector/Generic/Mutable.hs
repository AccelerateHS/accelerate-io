...
instance Elt e => V.MVector MVector e where
  ...
  basicUnsafeSlice j m (MArray _ mad) = MArray ((),m) (go arrayElt mad 1)
    where
      ...
      go ArrayEltRint            (AD_Int v)      s = AD_Int     (offset v s)
      go ArrayEltRint8           (AD_Int8 v)     s = AD_Int8    (offset v s)
      go ArrayEltRint16          (AD_Int16 v)    s = AD_Int16   (offset v s)
      go ArrayEltRint32          (AD_Int32 v)    s = AD_Int32   (offset v s)
      go ArrayEltRint64          (AD_Int64 v)    s = AD_Int64   (offset v s)
      go ArrayEltRword           (AD_Word v)     s = AD_Word    (offset v s)
      go ArrayEltRword8          (AD_Word8 v)    s = AD_Word8   (offset v s)
      go ArrayEltRword16         (AD_Word16 v)   s = AD_Word16  (offset v s)
      go ArrayEltRword32         (AD_Word32 v)   s = AD_Word32  (offset v s)
      go ArrayEltRword64         (AD_Word64 v)   s = AD_Word64  (offset v s)
      go ArrayEltRcshort         (AD_CShort v)   s = AD_CShort  (offset v s)
      go ArrayEltRcushort        (AD_CUShort v)  s = AD_CUShort (offset v s)
      go ArrayEltRcint           (AD_CInt v)     s = AD_CInt    (offset v s)
      go ArrayEltRcuint          (AD_CUInt v)    s = AD_CUInt   (offset v s)
      go ArrayEltRclong          (AD_CLong v)    s = AD_CLong   (offset v s)
      go ArrayEltRculong         (AD_CULong v)   s = AD_CULong  (offset v s)
      go ArrayEltRcllong         (AD_CLLong v)   s = AD_CLLong  (offset v s)
      go ArrayEltRcullong        (AD_CULLong v)  s = AD_CULLong (offset v s)
      go ArrayEltRhalf           (AD_Half v)     s = AD_Half    (offset v s)
      go ArrayEltRfloat          (AD_Float v)    s = AD_Float   (offset v s)
      go ArrayEltRdouble         (AD_Double v)   s = AD_Double  (offset v s)
      go ArrayEltRcfloat         (AD_CFloat v)   s = AD_CFloat  (offset v s)
      go ArrayEltRcdouble        (AD_CDouble v)  s = AD_CDouble (offset v s)
      go ArrayEltRbool           (AD_Bool v)     s = AD_Bool    (offset v s)
      go ArrayEltRchar           (AD_Char v)     s = AD_Char    (offset v s)
      go ArrayEltRcchar          (AD_CChar v)    s = AD_CChar   (offset v s)
      go ArrayEltRcschar         (AD_CSChar v)   s = AD_CSChar  (offset v s)
      go ArrayEltRcuchar         (AD_CUChar v)   s = AD_CUChar  (offset v s)
      ...
      offset :: forall a. Storable a => UniqueArray a -> Int -> UniqueArray a
      offset (UniqueArray uid (Lifetime lft w fp)) s =
