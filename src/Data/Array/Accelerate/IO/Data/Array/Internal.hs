...
-- |
-- Module      : Data.Array.Accelerate.IO.Data.Array.Internal -- Copyright   : [2017] Trevor L. McDonell
-- License     : BSD3
--
...
arrayEltRvecWidthUnboxed :: forall n a. KnownNat n => ArrayEltR (Vec n a) -> Int#
arrayEltRvecWidthUnboxed _ = let !(I# w#) = fromIntegral (natVal (Proxy @n))
                             in w#
